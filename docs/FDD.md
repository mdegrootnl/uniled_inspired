...
| Legacy-only old-UniLED BLE controllers | `SP107E`, `SP110E` | BLE autodiscovery, UUID diagnostics, and limited LED Chord/LED Hue command/status support now; hidden config/edit surfaces pending |
